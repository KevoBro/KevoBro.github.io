...
export default function About(): React.ReactElement {
  return (
    ...
    <section id="about" className=" order-2 md:order-1 bg-white/35 rounded-lg py-8 shadow-md w-fit md:w-2xl px-8 border-3 border-[#759DC5]">
    ...
    <div className="md:w-xl w-fit h-fit pt-6 pb-2 px-3 shadow-md bg-white/35 rounded-lg border-3 border-[#759DC5] relative z-0">
